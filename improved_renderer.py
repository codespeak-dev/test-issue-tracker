#!/usr/bin/env python3
"""
Improved template renderer with better Django template syntax handling.
"""
...
def evaluate_condition(condition, context):
    ...
    if condition == 'user.is_authenticated':
        ...
        tags = get_nested_value(context, 'issue.tags.all', [])
...
def create_context_from_json(json_data):
    """Create template context from JSON data"""
...
def render_template_file(template_path, json_path, output_path):
    ...
    try:
        ...
        # Create context
        context = create_context_from_json(json_data)
